    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-20">
        <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-b from-background via-background to-muted/30">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1614732414444-096e5f1122d5?w=1920&h=1080')] opacity-5 bg-cover bg-center" />
          <div className="container mx-auto px-4 relative z-10 max-w-6xl">
            <div className="text-center space-y-8">
              <div className="space-y-4">
                <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-orange-500 via-red-500 to-orange-500 bg-clip-text text-transparent animate-pulse">
                  RUSTICA
                </h1>
              ...
              <div className="flex flex-wrap gap-4 justify-center pt-8">
                ...
                <Button size="lg" variant="outline" className="gap-2" onClick={() => navigate('/shop')}>
                  <Icon name="ShoppingBag" size={20} />
                  Магазин
                </Button>
              </div>
